...
namespace Common.WebApiCore
{
    public class JwtManager
    {
        ...
        public Token GenerateToken<TUser>(TUser user) where TUser : BaseUser
        {
            var token = new Token
            {
        ...
        private string CreateToken<TUser>(TUser user, DateTime expiration, SigningCredentials credentials) where TUser : BaseUser
        {
        ...
        private ClaimsIdentity GenerateClaimsIdentity<TUser>(TUser user) where TUser : BaseUser
        {
