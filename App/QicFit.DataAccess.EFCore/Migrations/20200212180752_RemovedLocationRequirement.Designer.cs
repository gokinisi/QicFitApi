...
namespace QicFit.DataAccess.EFCore.Migrations
{
    ...
    [Migration("20200212180752_RemovedLocationRequirement")]
    partial class RemovedLocationRequirement
    {
            ...
            modelBuilder.Entity("QicFit.Entities.Workout", b =>
                {
                    ...
                    b.HasOne("QicFit.Entities.Radius", "Radius")
                        .WithOne("Workout")
                        .HasForeignKey("QicFit.Entities.Workout", "RadiusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QicFit.Entities.WorkoutType", "WorkoutType")
                        .WithOne("Workout")
                        .HasForeignKey("QicFit.Entities.Workout", "WorkoutTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
