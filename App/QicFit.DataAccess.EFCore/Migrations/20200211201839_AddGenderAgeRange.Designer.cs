...
namespace QicFit.DataAccess.EFCore.Migrations
{
    ...
    [Migration("20200211201839_AddGenderAgeRange")]
    partial class AddGenderAgeRange
    {
            ...
            modelBuilder.Entity("QicFit.Entities.AgeGroup", b =>
                {
                    ...
                    b.ToTable("AgeGroupConfig");
                });

            modelBuilder.Entity("QicFit.Entities.AgeRange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QicFit.Entities.AgeRange", b =>
                {
                    b.HasOne("QicFit.Entities.Workout", "Workout")
                        .WithOne("AgeRange")
                        .HasForeignKey("QicFit.Entities.AgeRange", "WorkoutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QicFit.Entities.Gender", b =>
                {
                    b.HasOne("QicFit.Entities.Workout", "Workout")
                        .WithOne("Gender")
                        .HasForeignKey("QicFit.Entities.Gender", "WorkoutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QicFit.Entities.Location", b =>
                {
                    b.HasOne("QicFit.Entities.Workout", "Workout")
                        .WithOne("Location")
                        .HasForeignKey("QicFit.Entities.Location", "WorkoutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
